...
FutureQuoteFeedForCache::FutureQuoteFeedForCache(QuoteBrokerList* _quote_broker_list, HANDLE* _event, GeneralMessageHandler _handler):
	FutureQuoteFeed(_quote_broker_list, _event, _handler)
{
}
