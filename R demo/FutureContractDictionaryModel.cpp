...
void FutureContractDictionaryModel::CreateTable(SQLite* db, DatabaseErrorMessageHandler handler)
{
	db->AddFieldNotNull("contract_id", TEXT);
	db->AddFieldNotNull("exchange", TEXT);
	db->AddFieldNotNull("deliver_year", INTEGER);
	db->AddFieldNotNull("deliver_month", INTEGER);
	db->AddFieldNotNull("volume_multiple", INTEGER);
	db->AddFieldNotNull("price_tick", _DOUBLE);
	db->AddFieldNotNull("expire_date", TEXT);
	db->AddFieldNotNull("start_deliver_date", TEXT);
	db->AddFieldNotNull("end_deliver_date", TEXT);
	db->AddFieldNotNull("buy_margin_ratio", _DOUBLE);
	db->AddFieldNotNull("sell_margin_ratio", _DOUBLE);
	(*handler)(db->CreateTable("contract_dictionary"));
}
