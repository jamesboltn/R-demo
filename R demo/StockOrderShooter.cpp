...
void StockOrderShooter::Shoot(char* contract, double price, Direction direction, OpenFlag open_flag, int volume, BrokerInfo* broker_info, InvestAccountSync* invest_account)
{
	//深A股东代码 0153275142
	//沪A股东代码 A408070359
...
void StockOrderShooter::Cancel(BrokerInfo* broker_info, InvestAccountSync* invest_account, OrderCredential* oc)
{
