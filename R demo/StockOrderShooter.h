...
private:
	...
	bool all_positions_current;//所有持仓是否全为今仓
	OrderDetailSync od;
...
public:
	...
	double price_cursor;//价格游标
	unsigned int volume;//t+1可卖数量
	int position_local;//本地总持仓
	int position_server;//服务器总持仓
