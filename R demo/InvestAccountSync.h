...
public:
	...
	double balance = 0.0;//在期货中指动态权益
	double position_profit = 0.0;//持仓盈亏
	double close_profit = 0.0;//平仓盈亏
	double frozen = 0.0;//下单冻结
