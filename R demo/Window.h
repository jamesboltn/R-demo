...
typedef std::pair<long, long> CommandMessageID, NotifyMessageID;
typedef std::map<std::pair<long, long>, MessageHandler> CommandMessageMap, NotifyMessageMap;
/************************type definition for other WM_XXX messages***********************/
typedef std::unordered_map<unsigned int, MessageHandler> WindowMessageMap;
