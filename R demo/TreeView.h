...
public:
	...
	void GetSelectedItemText(char* buffer, unsigned int length);
	void GetParentOfSelectedItemText(char* buffer, unsigned int length);
	void GetChainedTextOfSelectedItem(char* buffer, unsigned int length);
};
