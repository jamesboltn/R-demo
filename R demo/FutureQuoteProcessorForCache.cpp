...
FutureQuoteProcessorForCache::FutureQuoteProcessorForCache(FutureQuoteFeedForCache* _quote_feed, QuoteBroker* _quote_broker, InvestAccountSync* _invest_account, unsigned int _index) :
