...
FutureQuoteFeedForTrade::FutureQuoteFeedForTrade(BrokerInfoList* _broker_info_list, DWORD* _thread_id, HANDLE* _event, GeneralMessageHandler _handler):
	FutureQuoteFeed(_broker_info_list, _event, _handler)
{
	tick_cache_store_index = 0;
