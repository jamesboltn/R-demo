...
GuruLib::DataGrid* GuruLib::DataBind::bound_datagrid = NULL;
void GuruLib::DataBind::BindControl(unsigned int control_count, ...)
{
	va_list list1, list2;
...
void GuruLib::DataBind::BindControl(UIBase* uibase_ptr)
{
	if (typeid(*uibase_ptr) == typeid(Button))//it is a Button control
	{
...
void GuruLib::DataBind::RefreshControl(char* control_name, const char* value)
{
...
void GuruLib::DataBind::RefreshDataGrid(int row_index, char* col_name, const char* value)
{
	if (bound_datagrid != NULL)
	{
...
int GuruLib::DataBind::AddDataGridRow()
{
	if (bound_datagrid != NULL)
	{
...
void GuruLib::DataBind::DeleteDataGridRow(int row_index)
{
	if (bound_datagrid != NULL)
	{
