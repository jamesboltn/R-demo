...
void InvestAccountSync::UpdateErrorMessagePane(const std::string &err_msg)
{
	RefreshControl("err_msg_pane", err_msg.c_str());
}
void InvestAccountSync::UpdateErrorMessagePane(const char* err_msg)
{
	RefreshControl("err_msg_pane", err_msg);
}