...
FutureQuoteProcessorForTrade::FutureQuoteProcessorForTrade(FutureQuoteFeedForTrade* _quote_feed, BrokerInfo* _broker_info, InvestAccountSync* _invest_account, unsigned int _index):
